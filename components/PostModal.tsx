  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.smallField}>
        <span className={styles.fieldInput}>Title</span>
      ...
      <div className={styles.smallField}>
        <span className={styles.fieldInput}>Brief</span>
        <span className={styles.inputContainer}>
          <input
            className={styles.inputField}
            type="text"
      ...
      <div className={styles.smallField}>
        <span className={styles.fieldInput}>Banner Image URL</span>
        <span className={styles.inputContainer}>
          <input
            className={styles.inputField}
            type="text"
      ...
      <div className={styles.smallField}>
        <span className={styles.fieldInput}>Category</span>
        <span className={styles.inputContainer}>
          <input
            className={styles.inputField}
            type="text"
      ...
      <div className={styles.smallField}>
        <span className={styles.fieldInput}>Article Text</span>
        <span className={styles.inputContainer}>
          <textarea
            className={styles.inputField}
            type="text"
